...
module.exports = function (grunt) {
  ...
  concat: {
      ...
      header: {
        ...
        dest: 'frontend/dist/minified/assets/js/st.header.<%= pkg.version %>.js'
      },
      footer: {
        src: [
        ...
        dest: 'frontend/dist/minified/assets/js/st.footer.<%= pkg.version %>.js'
      }
    },
	 uglify: {
      header: {
      ...
      footer: {
        ...
        cdn: [ '<%= vendor_files.cdn_header %>' ],
        src: [ 'frontend/dist/minified/assets/js/st.header.<%= pkg.version %>.js' ]
      },
      release_footer: {
        dir: 'frontend/source/',
        result_dir: 'frontend/source/grunt_assets/index.scripts.temp/',
        ...
        cdn: [ '<%= vendor_files.cdn_footer %>' ],
        src: [ 'frontend/dist/minified/assets/js/st.footer.<%= pkg.version %>.js' ]
      },
        },
        includereplace: {
            index: {
